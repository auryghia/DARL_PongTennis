...
class CNNBody(nn.Module):
    def __init__(self, input_shape):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(c, 32, kernel_size=8, stride=4),  # Output: (32, ?)
            nn.ELU(),
        ...
        with torch.no_grad():
            ...
            self.flattened_size = self.conv(dummy).view(1, -1).size(1)
...
class A2CAgent:
    def __init__(self, env):
        ...
        self.lr = 2.5e-5
        self.gamma = 0.99
        self.ROWS, self.COLS, self.REM_STEP = 80, 80, 2
